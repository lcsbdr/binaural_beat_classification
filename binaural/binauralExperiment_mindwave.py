...
# This version is intended to be used with the Mindwave EEG device only and integrates EEG capturing.
if __name__ == '__main__':
    ...
    # init storage directory for capture files (stage + eeg data and timestamp)
    ...
    # init csv file with given structure
    ...
    # init background noise and open pygame audio channels
    ...
    for stage in stages:
        ...
        if stage != 'noise':
            while timer_sec <= 120:
                # create timestamp and get eeg data
